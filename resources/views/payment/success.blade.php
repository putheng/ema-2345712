	...
	<div class="px-3 pt-2">
		...
		<nav class="mb-4" aria-label="breadcrumb">
			<ol class="breadcrumb flex-lg-nowrap">
				...
				<li class="breadcrumb-item text-nowrap active" aria-current="page">Payment complete</li>
			</ol>
		</nav>
		<!-- Content-->
		<!-- Sorting-->
		<section class="d-md-flex justify-content-between align-items-center mb-4 pb-2">
			<h1 class="h2 mb-2 mb-md-0 mr-3">Thank you for your order.</h1>
		</section>
		<!-- Product grid-->

		<div class="row no-gutters pb-5 mb-xl-3">
			<div class="col-xl-6 mb-3">
				<h2 class="h5 mb-4">Transaction ID: {{ $data->reference_id }}</h2>
				<div value="1">
