                    ...
                    <div class="widget widget-links">
                      <ul class="widget-list">
                        ...
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Bread</a>
                        ...
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Bagels</a>
                          <ul class="widget-list pt-1">
                  ...
                  <div class="card-body px-grid-gutter pb-4">
                    <div class="widget widget-links">
                      <ul class="widget-list">
                        <li class="widget-list-item"><a class="widget-list-link" href="#">View all</a></li>
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Fruits</a>
                          <ul class="widget-list pt-1">
                  ...
                  <div class="card-body px-grid-gutter pb-4">
                    <div class="widget widget-links">
                      <ul class="widget-list">
                        <li class="widget-list-item"><a class="widget-list-link" href="#">View all</a></li>
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Milk</a>
                          <ul class="widget-list pt-1">
                        ...
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Cheese</a>
                          <ul class="widget-list pt-1">
                  ...
                  <div class="card-body px-grid-gutter pb-4">
                    <div class="widget widget-links">
                      <ul class="widget-list">
                        <li class="widget-list-item"><a class="widget-list-link" href="#">View all</a></li>
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Fresh meat</a>
                          <ul class="widget-list pt-1">
                        ...
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Meat delicatessen</a>
                          <ul class="widget-list pt-1">
                  ...
                  <div class="card-body px-grid-gutter pb-4">
                    <div class="widget widget-links">
                      <ul class="widget-list">
                        ...
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Prepared fish</a>
                          <ul class="widget-list pt-1">
                  ...
                  <div class="card-body px-grid-gutter pb-4">
                    <div class="widget widget-links">
                      <ul class="widget-list">
                        ...
                        <li class="widget-list-item">
                          <a class="widget-list-link" href="#">Sauces</a>
                          <ul class="widget-list pt-1">
