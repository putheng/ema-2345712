<section class="pb-5 mb-lg-3">
          ...
          <div class="card product-card-alt">
            ...
            <div class="card-body">
              <div class="d-flex flex-wrap justify-content-between align-items-start pb-2">
                <div class="text-muted font-size-xs mr-1">by <a class="product-meta font-weight-medium" href="{{ route('vendors.show') }}">Vendor. </a>in <a class="product-meta font-weight-medium" href="#">Category name</a></div>
      ...
      <div class="text-center">
        <a class="btn btn-outline-accent" href="{{ route('product') }}">
